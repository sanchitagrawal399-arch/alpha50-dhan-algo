...
import dhanhq  # Import everything safely
...
# ==============================================================================
# 🛡️ DHAN CONNECTION LAYER (VERIFIED VIA LOG INSPECTION)
# ==============================================================================
try:
    # 1. Initialize DhanContext exactly as inspected in logs
    ctx = dhanhq.DhanContext(client_id=CLIENT_ID, access_token=ACCESS_TOKEN)
    # 2. Pass the context instance into the main client class
    dhan = dhanhq.dhanhq(dhan_context=ctx)
    print("🎯 Connection handshake established successfully.")
except Exception as e:
...
try:
    # Testing integration with Dhan server endpoints
